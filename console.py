#!/usr/bin/python3
"""
Declare and executes the console
"""
import models
import sys
...
class HBNBCommand(Cmd):
    """Declare console commands and behavior"""
    prompt = "(hbnb) "
    ...
    def do_all(self, line):
        """Show all instances of a given model and if unspecified, all models"""
        try:
            tokens = split(line)
        except ValueError:
            return
    ...
    def do_destroy(self, line):
        """Delete or remove a given instance of a model"""
        try:
            tokens = split(line)
        except ValueError:
            return
