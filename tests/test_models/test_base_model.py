...
import models
base_doc = models.BaseModel._doc_
...
class TestDocBaseModule(unittest.TestCase):
    ...
    def test_doc_base(self):
        ...
        self.assertTrue(len(BaseModel._doc_) >= 1, "Doc Missing")
...
class TestBaseModel(unittest.TestCase):
    ...
    def Test_instance(self, mock_storage):
        ...
        for attr, type_at in type_attr.items():
            with self.subTest(attr=attr, typ=type_at):
                self.assertIn(attr, instance._dict_)
                self.assertIs(type(instance._dict_[attr]), type_at)
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(dict_inst['_class_'], 'BaseModel')
    ...
    def to_dict_value(self):
        ...
        self.assertEqual(dict_base["_class_"], "BaseModel")
